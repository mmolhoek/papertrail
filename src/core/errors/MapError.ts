...
export class MapError extends BaseError {
   ...
   */
  static trackNotFound(filePath: string, trackIndex: number, trackCount: number): MapError {
    return new MapError(
   ...
   */
  static fileTooLarge(filePath: string, size: number, maxSize: number): MapError {
    return new MapError(
